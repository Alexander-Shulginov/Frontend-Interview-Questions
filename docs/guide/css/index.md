...
- пиксели `px` самая распространенная и простая единица измерения
- помимо пикселей существует ряд других абсолютных единиц измерения, таких как сантиметры, дюймы, пункты, но они редко используются
