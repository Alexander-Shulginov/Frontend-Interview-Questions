...
-   _Смежные_ `label + input` стили применяться если элементы распологаются на одном уровне вложенности
...
По умолчанию, элементы распологаются в _нормальном потоке_, блочные распологаются друг под другом и занимают всю доступную ширину, строчные распологаются друг за другом, ширина таких элементов равна ширине контента расположенного в них.
